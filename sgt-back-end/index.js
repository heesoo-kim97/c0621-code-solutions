...
const db = new pg.Pool({
  coonectionString: 'postgres://dev:dev@localhost/studentGradeTable',
  ssl: {
...
app.post('api/grades', (req, res) => {
  ...
  const newSql = 'insert into "grades" ("name", "course", "score") values ($1, $2, $3) returning *;';
  ...
  db.query(newSql, params).then(result => {
